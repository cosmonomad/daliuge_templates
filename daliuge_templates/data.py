"""
daliuge_templates component module.

This is the module of daliuge_templates containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/daliuge_templates.MyData/String/readonly/
